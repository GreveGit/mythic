...
function RetrieveComponents()
	...
	EntityTypes = exports["mancave-core"]:FetchComponent("EntityTypes")
...
AddEventHandler("Core:Shared:Ready", function()
	exports["mancave-core"]:RequestDependencies("Inventory", {
		"Database",
		"Callbacks",
		"Sequence",
		"Fetch",
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["mancave-core"]:RegisterComponent("Inventory", INVENTORY)
end)
