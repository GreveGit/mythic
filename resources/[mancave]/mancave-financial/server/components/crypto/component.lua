...
AddEventHandler("Core:Shared:Ready", function()
	exports["mancave-core"]:RequestDependencies("Crypto", {
		"Fetch",
		"Utils",
        "Execute",
        "Chat",
		...
		if #error > 0 then
			exports["mancave-core"]:FetchComponent("Logger"):Critical("Crypto", "Failed To Load All Dependencies")
			return
		end
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["mancave-core"]:RegisterComponent("Crypto", _CRYPTO)
end)
