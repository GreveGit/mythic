...
function RetrieveComponents()
	...
	Visuals = exports["mancave-core"]:FetchComponent("Visuals")
	RegisterChatCommands()
end

AddEventHandler("Core:Shared:Ready", function()
	exports["mancave-core"]:RequestDependencies("Visuals", {
		"Chat",
        "Visuals",
	}, function(error)
		if #error > 0 then
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["mancave-core"]:RegisterComponent("Visuals", VISUALS)
end)
