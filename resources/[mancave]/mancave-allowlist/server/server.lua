...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["mancave-core"]:RegisterComponent("Queue", QUEUE)
end)

AddEventHandler("Queue:Shared:DependencyUpdate", RetrieveComponents)
function RetrieveComponents()
	c = exports["mancave-core"]:FetchComponent("Config")
	Database = exports["mancave-core"]:FetchComponent("Database")
	WebAPI = exports["mancave-core"]:FetchComponent("WebAPI")
	Punishment = exports["mancave-core"]:FetchComponent("Punishment")
	Queue = exports["mancave-core"]:FetchComponent("Queue")
	Convar = exports["mancave-core"]:FetchComponent("Convar")
...
AddEventHandler("Core:Shared:Ready", function()
	exports["mancave-core"]:RequestDependencies("Queue", {
		"Config",
		"Database",
		"WebAPI",
		"Punishment",
...
CreateThread(function()
	...
	if not exports["mancave-core"]:FetchComponent("WebAPI").Enabled then
