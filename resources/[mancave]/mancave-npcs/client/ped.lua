...
function RetrieveComponents()
	...
	Spawn = exports["mancave-core"]:FetchComponent("Spawn")
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["mancave-core"]:RegisterComponent("Ped", PED)
end)
