...
function RetrieveObjectsComponents()
	...
	Objects = exports["mancave-core"]:FetchComponent("Objects")
end

AddEventHandler("Core:Shared:Ready", function()
	exports["mancave-core"]:RequestDependencies("Objects", {
        "Callbacks",
        "Notification",
        "Targeting",
        "Inventory",
		...
		if #error > 0 then 
            exports["mancave-core"]:FetchComponent("Logger"):Critical("Objects", "Failed To Load All Dependencies")
			return
		end
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["mancave-core"]:RegisterComponent("Objects", _OBJECTS)
end)
