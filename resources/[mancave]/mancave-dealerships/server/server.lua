...
function RetrieveComponents()
    ...
    Dealerships = exports['mancave-core']:FetchComponent('Dealerships')
    ...
    Default = exports['mancave-core']:FetchComponent('Default')
    Chat = exports['mancave-core']:FetchComponent('Chat')
    MDT = exports['mancave-core']:FetchComponent('MDT')
end

AddEventHandler('Core:Shared:Ready', function()
    exports['mancave-core']:RequestDependencies('Dealerships', {
        'Database',
        'Callbacks',
        'Logger',
        'Utils',
...
AddEventHandler('Proxy:Shared:RegisterReady', function()
    exports['mancave-core']:RegisterComponent('Dealerships', DEALERSHIPS)
end)
