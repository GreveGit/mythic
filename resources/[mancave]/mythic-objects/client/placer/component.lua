...
AddEventHandler("Core:Shared:Ready", function()
	exports["mancave-core"]:RequestDependencies("ObjectPlacer", {
        "Notification",
        "Targeting",
        "ObjectPlacer",
	}, function(error)
		if #error > 0 then 
            exports["mancave-core"]:FetchComponent("Logger"):Critical("ObjectPlacer", "Failed To Load All Dependencies")
			return
		end
		RetrieveComponents()
	end)
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["mancave-core"]:RegisterComponent("ObjectPlacer", _PLACER)
end)